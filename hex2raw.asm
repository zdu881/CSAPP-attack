...
0000000000400728 <_init>:
  ...
  40072c:	e8 0b 01 00 00       	call   40083c <call_gmon_start>
...
0000000000400740 <.plt>:
  400740:	ff 35 aa 18 20 00    	push   0x2018aa(%rip)        # 601ff0 <_GLOBAL_OFFSET_TABLE_+0x8>
  400746:	ff 25 ac 18 20 00    	jmp    *0x2018ac(%rip)        # 601ff8 <_GLOBAL_OFFSET_TABLE_+0x10>
  40074c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000400750 <free@plt>:
  400750:	ff 25 aa 18 20 00    	jmp    *0x2018aa(%rip)        # 602000 <free@GLIBC_2.2.5>
  400756:	68 00 00 00 00       	push   $0x0
  40075b:	e9 e0 ff ff ff       	jmp    400740 <.plt>

0000000000400760 <__isoc99_fscanf@plt>:
  400760:	ff 25 a2 18 20 00    	jmp    *0x2018a2(%rip)        # 602008 <__isoc99_fscanf@GLIBC_2.7>
  400766:	68 01 00 00 00       	push   $0x1
  40076b:	e9 d0 ff ff ff       	jmp    400740 <.plt>

0000000000400770 <write@plt>:
  400770:	ff 25 9a 18 20 00    	jmp    *0x20189a(%rip)        # 602010 <write@GLIBC_2.2.5>
  400776:	68 02 00 00 00       	push   $0x2
  40077b:	e9 c0 ff ff ff       	jmp    400740 <.plt>

0000000000400780 <__libc_start_main@plt>:
  400780:	ff 25 92 18 20 00    	jmp    *0x201892(%rip)        # 602018 <__libc_start_main@GLIBC_2.2.5>
  400786:	68 03 00 00 00       	push   $0x3
  40078b:	e9 b0 ff ff ff       	jmp    400740 <.plt>

0000000000400790 <malloc@plt>:
  400790:	ff 25 8a 18 20 00    	jmp    *0x20188a(%rip)        # 602020 <malloc@GLIBC_2.2.5>
  400796:	68 04 00 00 00       	push   $0x4
  40079b:	e9 a0 ff ff ff       	jmp    400740 <.plt>

00000000004007a0 <__isoc99_sscanf@plt>:
  4007a0:	ff 25 82 18 20 00    	jmp    *0x201882(%rip)        # 602028 <__isoc99_sscanf@GLIBC_2.7>
  4007a6:	68 05 00 00 00       	push   $0x5
  4007ab:	e9 90 ff ff ff       	jmp    400740 <.plt>

00000000004007b0 <realloc@plt>:
  4007b0:	ff 25 7a 18 20 00    	jmp    *0x20187a(%rip)        # 602030 <realloc@GLIBC_2.2.5>
  4007b6:	68 06 00 00 00       	push   $0x6
  4007bb:	e9 80 ff ff ff       	jmp    400740 <.plt>

00000000004007c0 <fopen@plt>:
  4007c0:	ff 25 72 18 20 00    	jmp    *0x201872(%rip)        # 602038 <fopen@GLIBC_2.2.5>
  4007c6:	68 07 00 00 00       	push   $0x7
  4007cb:	e9 70 ff ff ff       	jmp    400740 <.plt>

00000000004007d0 <getopt@plt>:
  4007d0:	ff 25 6a 18 20 00    	jmp    *0x20186a(%rip)        # 602040 <getopt@GLIBC_2.2.5>
  4007d6:	68 08 00 00 00       	push   $0x8
  4007db:	e9 60 ff ff ff       	jmp    400740 <.plt>

00000000004007e0 <fwrite@plt>:
  4007e0:	ff 25 62 18 20 00    	jmp    *0x201862(%rip)        # 602048 <fwrite@GLIBC_2.2.5>
  4007e6:	68 09 00 00 00       	push   $0x9
  4007eb:	e9 50 ff ff ff       	jmp    400740 <.plt>

00000000004007f0 <__fprintf_chk@plt>:
  4007f0:	ff 25 5a 18 20 00    	jmp    *0x20185a(%rip)        # 602050 <__fprintf_chk@GLIBC_2.3.4>
  4007f6:	68 0a 00 00 00       	push   $0xa
  4007fb:	e9 40 ff ff ff       	jmp    400740 <.plt>

0000000000400800 <__ctype_b_loc@plt>:
  400800:	ff 25 52 18 20 00    	jmp    *0x201852(%rip)        # 602058 <__ctype_b_loc@GLIBC_2.3>
  400806:	68 0b 00 00 00       	push   $0xb
  40080b:	e9 30 ff ff ff       	jmp    400740 <.plt>
...
0000000000400810 <_start>:
  ...
  400834:	e8 47 ff ff ff       	call   400780 <__libc_start_main@plt>
  400839:	f4                   	hlt    
  40083a:	90                   	nop
  40083b:	90                   	nop
...
00000000004008d0 <__do_global_dtors_aux>:
  ...
  4008dd:	e8 7e ff ff ff       	call   400860 <deregister_tm_clones>
  4008e2:	5d                   	pop    %rbp
...
00000000004008f0 <frame_dummy>:
  ...
  40090d:	ff d0                	call   *%rax
  40090f:	5d                   	pop    %rbp
  400910:	e9 7b ff ff ff       	jmp    400890 <register_tm_clones>
  400915:	0f 1f 00             	nopl   (%rax)
  400918:	e9 73 ff ff ff       	jmp    400890 <register_tm_clones>
  40091d:	90                   	nop
  40091e:	90                   	nop
  40091f:	90                   	nop
...
0000000000400920 <usage>:
  ...
  40093d:	e8 ae fe ff ff       	call   4007f0 <__fprintf_chk@plt>
  ...
  400958:	e8 83 fe ff ff       	call   4007e0 <fwrite@plt>
  ...
  400973:	e8 68 fe ff ff       	call   4007e0 <fwrite@plt>
  ...
  40098e:	e8 4d fe ff ff       	call   4007e0 <fwrite@plt>
...
0000000000400998 <convert_to_hex_value>:
  ...
  4009ab:	e8 f0 fd ff ff       	call   4007a0 <__isoc99_sscanf@plt>
...
00000000004009ba <convert_to_byte_string>:
  ...
  4009de:	e8 ad fd ff ff       	call   400790 <malloc@plt>
  ...
  400a06:	e9 11 01 00 00       	jmp    400b1c <convert_to_byte_string+0x162>
  ...
  400a2f:	e9 e8 00 00 00       	jmp    400b1c <convert_to_byte_string+0x162>
  ...
  400a65:	e8 86 fd ff ff       	call   4007f0 <__fprintf_chk@plt>
  400a6a:	48 8b 7d c8          	mov    -0x38(%rbp),%rdi
  400a6e:	e8 dd fc ff ff       	call   400750 <free@plt>
  400a73:	b8 00 00 00 00       	mov    $0x0,%eax
  400a78:	e9 d5 00 00 00       	jmp    400b52 <convert_to_byte_string+0x198>
  400a7d:	41 83 ed 01          	sub    $0x1,%r13d
  400a81:	e9 96 00 00 00       	jmp    400b1c <convert_to_byte_string+0x162>
  400a86:	45 85 ed             	test   %r13d,%r13d
  400a89:	0f 85 8d 00 00 00    	jne    400b1c <convert_to_byte_string+0x162>
  400a8f:	e8 6c fd ff ff       	call   400800 <__ctype_b_loc@plt>
  ...
  400ace:	e8 1d fd ff ff       	call   4007f0 <__fprintf_chk@plt>
  400ad3:	48 8b 7d c8          	mov    -0x38(%rbp),%rdi
  400ad7:	e8 74 fc ff ff       	call   400750 <free@plt>
  400adc:	b8 00 00 00 00       	mov    $0x0,%eax
  400ae1:	eb 6f                	jmp    400b52 <convert_to_byte_string+0x198>
  400ae3:	48 89 df             	mov    %rbx,%rdi
  400ae6:	e8 ad fe ff ff       	call   400998 <convert_to_hex_value>
  ...
  400aff:	e8 ac fc ff ff       	call   4007b0 <realloc@plt>
  ...
  400b2c:	e8 2f fc ff ff       	call   400760 <__isoc99_fscanf@plt>
...
0000000000400b61 <main>:
  ...
  400b6e:	4c 8b 25 fb 14 20 00 	mov    0x2014fb(%rip),%r12        # 602070 <stdin@GLIBC_2.2.5>
  ...
  400bca:	e8 21 fc ff ff       	call   4007f0 <__fprintf_chk@plt>
  400bcf:	b8 01 00 00 00       	mov    $0x1,%eax
  400bd4:	e9 ba 00 00 00       	jmp    400c93 <main+0x132>
  400bd9:	48 8b 3b             	mov    (%rbx),%rdi
  400bdc:	e8 3f fd ff ff       	call   400920 <usage>
  400be1:	b8 01 00 00 00       	mov    $0x1,%eax
  400be6:	e9 a8 00 00 00       	jmp    400c93 <main+0x132>
  400beb:	ba 70 0e 40 00       	mov    $0x400e70,%edx
  400bf0:	48 89 de             	mov    %rbx,%rsi
  400bf3:	89 ef                	mov    %ebp,%edi
  400bf5:	e8 d6 fb ff ff       	call   4007d0 <getopt@plt>
  ...
  400c0a:	e8 ab fd ff ff       	call   4009ba <convert_to_byte_string>
  ...
  400c26:	e8 45 fb ff ff       	call   400770 <write@plt>
  ...
  400c82:	e8 59 fb ff ff       	call   4007e0 <fwrite@plt>
...
0000000000400ca0 <__libc_csu_init>:
  ...
  400caa:	48 8d 2d 4f 11 20 00 	lea    0x20114f(%rip),%rbp        # 601e00 <__do_global_dtors_aux_fini_array_entry>
  ...
  400ce0:	e8 43 fa ff ff       	call   400728 <_init>
  ...
  400cf9:	41 ff 14 dc          	call   *(%r12,%rbx,8)
